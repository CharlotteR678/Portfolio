    ...
    <div className="homePageDiv">
      ...
      <div id="descriptiondiv">
        ...
        <p id="pHP">
          ...
          intensive de 5 mois à la Wild Code School. Cette immersion m'a permis
          d'acquérir des compétences en développement Web et Web Mobile
          fullstack, sur JS/REACT. Je suis maintenant prête à mettre en pratique
          ces connaissances à travers une alternance, afin de relever de
          nouveaux défis et de contribuer activement à des projets innovants.
        </p>
        <Link to="/some-path">
